...
!(function () {
   ...
   var T = R(
      ...
      F = R(
         ...
         s(u, L, { fass: 'fa-solid', fasr: 'fa-regular' }),
         u)
      ),
      H = R(
         (s((b = {}), I, {
         ...
         s(b, L, { 'fa-solid': 'fass', 'fa-regular': 'fasr' }),
         b)
      ),
   ...
   var xt = ut.styles,
      At = ut.shims,
      Ot =
         (s((u = {}), I, Object.values(F[I])), s(u, L, Object.values(F[L])), u),
      Nt = null,
      Pt = {},
      Ct = {},
      St = {},
   ...
   function pa(e, t) {
      ...
      0 === e.length
         ...
         : (J.mutateApproach === E ? g.requestAnimationFrame || ba : ba)(
              function () {
                 var t =
                       (!0 !== J.autoReplaceSvg && da[J.autoReplaceSvg]) ||
                       da.replace,
                    a = ca.begin('mutate')
                 e.map(t), a(), n()
              }
                     ...
                     return (
                        ...
                        (t = {
                           ...
                           extra: {
                              ...
                              styles: f,
                              classes: [
                                 ''.concat(J.cssPrefix, '-layers-counter'),
                              ].concat(l(s)),
                           },
                        }),
                        (a = t.content),
                     ...
                     return (
                        ...
                        $t({
                           ...
                           extra: {
                              ...
                              styles: s,
                              classes: [
                                 ''.concat(J.cssPrefix, '-layers-text'),
                              ].concat(l(r)),
                           },
                        })
                     )
      ...
      return new Promise(function (e, t) {
         ...
         u && 'none' !== d && '' !== d
            ? ((s = l.getPropertyValue('content')),
              ...
              !u ||
              c ||
              (f && f.getAttribute(C) === n && f.getAttribute(S) === i)
                 ? e()
                 : (b.setAttribute(v, i),
                   f && b.removeChild(f),
                   ((o = (r = {
